...
public class Menu {
    ...
    private static void subNonStaticMethodMenu() {
    ...
    private static void subStaticMethodMenu() {
    ...
    private static void subContinueMenu() {
    ...
    private static void subBreakMenu() {
    ...
    private static void subDoWhileMenu() {
    ...
    private static void subWhileMenu() {
    ...
    private static void subForMenu() {
    ...
    private static void subSwitchMenu() {
    ...
    private static void subVarMenu() {
    ...
    private static void subPTypeMenu() {
